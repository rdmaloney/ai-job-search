...
- Extract: **company name**, **role title**, **department** (if mentioned), **location**, and **language** of the posting (English, unless the target market suggests otherwise).
...
- **Match the language of the job posting** (English posting -> English cover letter; if targeting a non-English-speaking market, match that language)
